...
// f() takes arbitrary number of parameters and returns its
// number
// printCommaSeparatedList() expects one or more parameters
// and returns them in a comma separated list
// new operator sizeof...
